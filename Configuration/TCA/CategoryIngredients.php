...
$GLOBALS['TCA']['tx_racletterecipe_domain_model_categoryingredients'] = array(
	...
	'columns' => array(
		...
		'title' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:raclette_recipe/Resources/Private/Language/locallang_db.xlf:tx_racletterecipe_domain_model_categoryingredients.title',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
		...
		'description' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:raclette_recipe/Resources/Private/Language/locallang_db.xlf:tx_racletterecipe_domain_model_categoryingredients.description',
			'config' => array(
				'type' => 'text',
				'cols' => 40,
				'rows' => 15,
